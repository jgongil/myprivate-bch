...
This project demonstrates the fundamentals concepts of a Blockchain platform.
Concepts like:
    - Block
    - Blockchain
    - Wallet
...
Using a boilerplate code with a REST Api already setup we expose some of the functionalities
